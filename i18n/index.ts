...
const enTranslations = {
  ...
  "form.speech.startRecording": "Start voice input",
  "form.speech.stopRecording": "Stop voice input",
  "form.speech.error.notSupported": "Speech recognition is not supported in your browser.",
  "form.speech.error.permission": "Microphone access was denied. Please enable it in your browser settings to use this feature.",
...
const deTranslations = {
  ...
  "form.speech.startRecording": "Spracheingabe starten",
  "form.speech.stopRecording": "Spracheingabe stoppen",
  "form.speech.error.notSupported": "Spracherkennung wird in Ihrem Browser nicht unterstützt.",
  "form.speech.error.permission": "Mikrofonzugriff verweigert. Bitte aktivieren Sie ihn in Ihren Browsereinstellungen, um diese Funktion zu nutzen.",
