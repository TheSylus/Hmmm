...
const enTranslations = {
  ...
  "share.text.rating": "Rating",
  "share.text.notes": "My Notes",
  "share.text.tags": "Tags",
  "share.text.checkOut": "Check out \"{name}\" which I saved in the Food Memory Tracker app.",
...
const deTranslations = {
  ...
  "share.text.rating": "Bewertung",
  "share.text.notes": "Meine Notizen",
  "share.text.tags": "Tags",
  "share.text.checkOut": "Schau dir \"{name}\" an, das ich im Lebensmittel-Tracker gespeichert habe.",
