...
const enTranslations = {
  ...
  "form.ingredients.title": "Ingredients & Allergens",
  "form.ingredients.loading": "Scanning ingredients list...",
  "form.ingredients.allergens": "Allergens",
  "form.ingredients.ingredientsList": "Ingredients",
  "form.ingredients.placeholder": "No ingredients scanned. Use the scan button to add them from the product label.",
  ...
  "card.allergensTitle": "Contains Allergens",
...
const deTranslations = {
  ...
  "form.ingredients.title": "Zutaten & Allergene",
  "form.ingredients.loading": "Zutatenliste wird gescannt...",
  "form.ingredients.allergens": "Allergene",
  "form.ingredients.ingredientsList": "Zutaten",
  "form.ingredients.placeholder": "Keine Zutaten gescannt. Scanne das Etikett, um sie hinzuzufügen.",
  ...
  "card.allergensTitle": "Enthält Allergene",
