...
const enTranslations = {
  ...
  "form.button.dictate": "Dictate Product",
  ...
  "speechModal.description": "Start speaking, and the product name will be transcribed.",
...
const deTranslations = {
  ...
  "form.button.dictate": "Produkt diktieren",
  ...
  "speechModal.description": "Sprechen Sie einfach, und der Produktname wird transkribiert.",
